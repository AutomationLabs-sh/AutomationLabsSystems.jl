...
@testset "Linearize a non linear discrete system with constraint" begin
...
@testset "Linearize a non linear continuous system with constraint" begin
...
@testset "Linearize a non linear discrete system without constraint" begin
...
@testset "Linearize a non linear continuous system without constraint" begin
